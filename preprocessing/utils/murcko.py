...
def murcko_histogram_to_key(histogram: dict) -> str:
    """
    Convert a Murcko histogram dict to a stable, hashable string.
    Sorting by key ensures {'0_1':1, '1_0':1} and {'1_0':1, '0_1':1}
...
def murcko_hist(mol: Mol, as_str: bool = False, 
    ...
    if as_str:
        return murcko_histogram_to_key(dict_hist)
    else:
        return hist_adj
